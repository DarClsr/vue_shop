<template>
			...
			<div class="store-content item">
				<div class="item-box">
					<div class="gallery-wrapper">	
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									<li :class="{'on':index==imgindex}" @click="tabimg(index)" v-for="(item,index) in itemInfo.ali_images"><img :src="item"></li>
								</ul>
							</div>
							<div class="thumb">
								<ul>
									<li :class="{'on':index==imgindex}" v-for="(item,index) in itemInfo.ali_images"><img :src="item?item:''"></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="banner">
						...
						<div class="sku-dynamic-params-panel">
							<div class="sku-dynamic-params clear">
								<span class="params-name">{{itemInfo.spec_json.color_title}}</span>
								<button class="params_btn">{{itemInfo.spec_json.show_name}}</button>
							</div>
							<div class="sku-dynamic-params clear">
				...
				<div class="item_info item-box">
					<div class="article" v-html="itemInfo.main_txt.article"></div>
				</div>
			</div>	
		</div>
</template>
...
<script>
	import allitemdata from '../lib/allshopitem.js';
	export default {
		data() {
			return {
...
.item-box .banner .sku-dynamic-params .params_btn{
	width: 150px;
	height: 40px;
	background: white;
